<div>
    ...
    <p class="text-gray-500">
        <a wire:click="toggleForm" class="rounded-md text-xs hover:underline cursor-pointer">
            Agregar comentario
        </a>
    </p>
    @else
        <form wire:submit="addComment" class="space-y-2">
            <div class="flex gap-2">
                ...
                <button type="button" wire:click="toggleForm" class="text-xs text-gray-300 hover:underline cursor-pointer">Cancelar</button>
